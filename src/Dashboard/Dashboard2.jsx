...
<div className=" xs:flex xs:justify-between px-4 py-3 flex justify-between items-center">
  ...
  <div className="flex items-center space-x-6">
    <div className="hidden md:flex space-x-6">
      <Link to="/dashboard3" className="text-gray-600 hover:text-gray-800 transition">Next</Link>
...
<div className="flex  mt-4 pt-3 justify-between border-t-2 items-center xs:flex xs:flex-col-reverse xs:justify-around  ">
          <div className="flex gap-4 ml-5">
            <div className="mb-4">
              ...
              <select
                id="language"
                className="border border-gray-300 text-[#808080] text-[15px] inter_ff font-normal rounded-md px-5 py-1 focus:outline-none focus:ring-blue-500 focus:ring-1"
              >
            ...
            <div className="mb-4">
              <label className="block text-[#808080] text-[15px] inter_ff font-normal mb-2" htmlFor="format">Output Format</label>
              <select
                id="format"

        ...
        <div className="bg-white rounded-lg xs:px-4 shadow-md pb-6 px-12">
          ...
          <div className='w-full flex xs:flex xs:flex-col xs:gap-4 xs:w-full '>
            ...
            <div className='xs:w-full xl:w-3/5 lg:w-3/5 bg-gradient-to-r from-[#408BFA] to-[#778EE5] pt-12 pl-6 rounded-3xl pb-8'>
              ...
              <p className='text-[22px] font-medium inter_ff text-white mt-6'>Create Text with Speech or Recording
                <br /> with EchoWrite</p>
              <p className=' bg-white rounded-3xl items-center mt-4' style={{ width: "94%" }}>
                <button className='text-[22px] font-medium inter_ff text-[#161C2D] w-full py-3  '>Start Project Now</button>
              </p>


            </div>
<div className='w-2/5 xs:w-full xs:m-0 flex gap-4 ml-4'>

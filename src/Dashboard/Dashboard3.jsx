    ...
    <div className=" mx-auto mt-16 px-8 pb-12 bg-[#F1F4F5] xs:m-0 xs:px-3 md:m-0 sm:m-0 " style={{
      ...
      <div className='py-4 flex justify-between items-center'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className={`lg:flex md:flex items-center ${menuOpen ? ' flex' : 'hidden'} lg:block`}>
            <p className='text-16 font-normal inter_ff lg:ml-4'><Link to="/Dashboard">Next</Link></p>
            <p className='text-16 font-normal inter_ff lg:ml-4'>Support</p>
            <p className='flex border rounded-2xl font-bold px-2 items-center lg:ml-4'>
              <span className='w-8 h-8 bg-[#FF9A26] flex justify-center items-center rounded-full text-white text-14 inter_ff mr-2'>J</span> John Doe
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md pb-4 px-12 xs:px-2">
        <div className='flex justify-between   md:flex md:flex-col  md:justify-around   sm:flex sm:flex-col  sm:justify-around  xs:flex xs:flex-col xs:justify-around lg:flex '>
          ...
          <div className={`lg:flex md:flex items-center ${menuOpen ? ' flex' : 'hidden'} lg:block`}>
            <p className='text-16 font-normal inter_ff lg:ml-4'><Link to="/Dashboard4">Next</Link></p>
            <p className='text-16 font-normal inter_ff lg:ml-4'>Support</p>
...
//         <div className='flex justify-between lg:flex lg:flex-col lg:justify-around'>

...
const Brands = () => {
  return (
    <div className="text-center px-3 pt-12">
      <h1 className="font-bold text-3xl md:text-4xl text-[#161C2D]">
      ...
      <div className="overflow-hidden w-full h-24 md:h-28 lg:h-32 mt-4">
        <div className="marquee flex space-x-4">
          <img src={Brand1} alt="Brand1" className="h-full" />
          <img src={Brand2} alt="Brand2" className="h-full" />
          <img src={Brand3} alt="Brand3" className="h-full" />
          <img src={Brand4} alt="Brand4" className="h-full" />
          <img src={Brand5} alt="Brand5" className="h-full" />
          <img src={Brand6} alt="Brand6" className="h-full" />
          <img src={Brand7} alt="Brand7" className="h-full" />
        </div>
      </div>
    </div>
  );

...
//           </button>
//         </div>
//         <div className="hidden md:flex gap-4 items-center flex-grow">
...
//   return (
//     <div className="relative bg-white">
//       <div className="container max-w-5xl mx-auto flex justify-between items-center py-5 px-4 md:px-8">

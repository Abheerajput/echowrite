...
const Section = () => {
  return (
    <div className="bg-[#F4F7FA] pb-8 lg:pb-0">
      <div className="container max-w-5xl mx-auto py-8 lg:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="flex flex-col  justify-center px-4 py-8 lg:pl-8 xl:pl-12">
            <h1 className=' text-[40px]  inter_ff  font-bold mb-4 text-[#161C2D] '>
            ...
            <button className='text-white inter_ff text-[17px] w-1/2 font-semibold bg-[#008CD2]  py-2 lg:py-3 rounded-full'>
              Learn how we work
            </button>
          </div>
          ...
          <div className="grid grid-rows-3 gap-8 py-8 px-4 lg:pr-8 xl:pr-12">
            <div>
